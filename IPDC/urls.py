...
urlpatterns = [
    ...
    path('investor_dashboard', views.investor_dashboard,
         name='investor_personal_information'),
    path('request_land', views.request_land, name='requestlandpage'),
    path('investor_file_information', views.investor_file_information,
         name='investor_file_information'),
    ...
    path('view_investor_profile/<str:pk>',
         views.view_investor_profile, name="view_investor_profile"),
    ...
    path('proposalSuggestions', views.proposalSuggestions,
         name="proposalSuggestions"),
