...
class DomesticRequest(models.Model):
    ...
    status = models.CharField(
        max_length=300, choices=status, default='onlist', blank=True)
...
class Privatechat(models.Model):
    ...
    secondary_user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='private')
...
class FeedBack(models.Model):
    ...
    domesticrequest = models.ForeignKey(
        DomesticRequest, on_delete=models.CASCADE)
